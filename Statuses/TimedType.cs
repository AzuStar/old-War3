...
//         public Status GetStatus(NUnit unit) => unit.GetStatus(Id);

//         public virtual Status ApplyStatus(NUnit source, NUnit target, int level, float duration, int bonusLevel = 0, float bonusDuration = 0)
//         {
...
//         public virtual void DispelStatus(NUnit unit)
//         {
