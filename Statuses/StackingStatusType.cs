...
//         //public Status ApplyStatus(NUnit source, NUnit target, int level, float duration, int applyStacks = 1)
//         //{
...
//         //private new Status ApplyStatus(NUnit source, NUnit target, int level, float duration)
//         //{
//         //    return null;
//         //}
